...
if (isset($_POST['btnUpdateCart'])) {
    ...
    foreach ($_SESSION['cart'] as &$item) {
        if (isset($_POST['quantity'][$item['key']])) {
                        ...
                        <form method="post"> <!-- Form to update cart -->
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    $totalAmount = 0;
                                    foreach ($mergedCart as $item) {
                                        $imagePath = 'img/' . htmlspecialchars($item['photo']);
                                        echo "<tr>";
                                        echo "<td><img src='" . $imagePath . "' alt='" . htmlspecialchars($item['name']) . "' style='width: 50px; height: 50px;' /></td>";
